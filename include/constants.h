...
{
    switch (pid) {
        case 0x00: return "Supported PIDs 00-1F";
        case 0x01: return "Monitor status since DTC clear";
        ...
        case 0x12: return "Commanded secondary air";
        case 0x13: return "O2 sensors present (banks 1-2)";
        case 0x14: return "O2 S1 B1 voltage / STFT";
        case 0x15: return "O2 S2 B1 voltage / STFT";
        case 0x16: return "O2 S3 B1 voltage / STFT";
        case 0x17: return "O2 S4 B1 voltage / STFT";
        case 0x18: return "O2 S1 B2 voltage / STFT";
        case 0x19: return "O2 S2 B2 voltage / STFT";
        case 0x1A: return "O2 S3 B2 voltage / STFT";
        case 0x1B: return "O2 S4 B2 voltage / STFT";
        case 0x1C: return "OBD standard the vehicle conforms to";
        case 0x1D: return "O2 sensors present (banks)";
        ...
        case 0x22: return "Fuel rail pressure (vacuum reference)";
        case 0x23: return "Fuel rail gauge pressure (diesel/direct)";
        case 0x24: return "O2 S1 wideband lambda (eq ratio / V)";
        case 0x25: return "O2 S2 wideband lambda (eq ratio / V)";
        case 0x26: return "O2 S3 wideband lambda (eq ratio / V)";
        case 0x27: return "O2 S4 wideband lambda (eq ratio / V)";
        case 0x28: return "O2 S5 wideband lambda (eq ratio / V)";
        case 0x29: return "O2 S6 wideband lambda (eq ratio / V)";
        case 0x2A: return "O2 S7 wideband lambda (eq ratio / V)";
        case 0x2B: return "O2 S8 wideband lambda (eq ratio / V)";
        case 0x2C: return "Commanded EGR";
        case 0x2D: return "EGR error";
        case 0x2E: return "Commanded evaporative purge";
        case 0x2F: return "Fuel level input";
        case 0x30: return "Warm-ups since DTC clear";
        case 0x31: return "Distance traveled since DTC clear";
        case 0x32: return "Evap system vapor pressure";
        case 0x33: return "Barometric pressure";
        case 0x34: return "O2 S1 wideband lambda (current)";
        case 0x35: return "O2 S2 wideband lambda (current)";
        case 0x36: return "O2 S3 wideband lambda (current)";
        case 0x37: return "O2 S4 wideband lambda (current)";
        case 0x38: return "O2 S5 wideband lambda (current)";
        case 0x39: return "O2 S6 wideband lambda (current)";
        case 0x3A: return "O2 S7 wideband lambda (current)";
        case 0x3B: return "O2 S8 wideband lambda (current)";
        case 0x3C: return "Catalyst temperature B1S1";
        case 0x3D: return "Catalyst temperature B2S1";
        case 0x3E: return "Catalyst temperature B1S2";
        case 0x3F: return "Catalyst temperature B2S2";
        ...
        case 0x44: return "Commanded equivalence ratio";
        ...
        case 0x4E: return "Time since DTCs cleared";
        case 0x4F: return "Max values for eq ratio, O2, MAP";
        case 0x50: return "Fuel type";
        case 0x51: return "Ethanol fuel percentage";
        case 0x52: return "Absolute evap system vapor pressure";
        case 0x53: return "Evap system vapor pressure";
        case 0x54: return "ST secondary O2 trim B1/B3";
        case 0x55: return "LT secondary O2 trim B1/B3";
        case 0x56: return "ST secondary O2 trim B2/B4";
        case 0x57: return "LT secondary O2 trim B2/B4";
        case 0x58: return "Fuel rail absolute pressure";
        case 0x59: return "Relative accelerator pedal position";
        case 0x5A: return "Hybrid battery pack remaining life";
        case 0x5B: return "Engine oil temperature";
        case 0x5C: return "Fuel injection timing";
        case 0x5D: return "Engine fuel rate";
        case 0x5E: return "Emission requirements (design)";
        case 0x5F: return "GM proprietary / reserved (0x5F)";

        case 0x60: return "Supported PIDs 61-80";
        case 0x61: return "Driver demand engine percent torque";
        case 0x62: return "Actual engine percent torque";
        case 0x63: return "Engine reference torque";
        case 0x64: return "Engine percent torque data (idle/points)";
        case 0x65: return "Aux input/output supported (GM)";
        case 0x66: return "Mass air flow sensor high-res (GM)";
        case 0x67: return "Engine coolant temp high-res (GM)";
        case 0x68: return "Intake air temp high-res (GM)";
        case 0x69: return "Commanded EGR / EGR error (GM)";
        case 0x6A: return "Evap purge flow (GM)";
        case 0x6B: return "Turbo / supercharger boost (GM)";
        case 0x6C: return "Charge air cooler outlet temp (GM)";
        case 0x6D: return "Exhaust gas temperature sensor (GM)";
        case 0x6E: return "Diesel particulate filter temp/pressure (GM)";
        case 0x6F: return "Engine friction percent torque";
        case 0x70: return "GM proprietary / reserved (0x70)";

        // Your custom PIDs (examples — rename as you like)
        case 0xC9: return "Adapter Temperature";
        case 0xCA: return "Adapter Humudity";
